...
const PreOpCareForm = () => {
  ...
  const checkboxes = [
    {
      ...
      checked: false,
      onChange: (checked) => console.log("Pre-Anesthesia Assessment:", checked),
    },
    {
  ...
  return (
    <CareForm
      ...
      formBtnName="Add Pre-op Care Form"
    />
  );
};

export default PreOpCareForm;
